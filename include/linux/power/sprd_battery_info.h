...
extern int sprd_battery_get_battery_info(struct power_supply *psy, struct sprd_battery_info *info);
#ifdef CONFIG_VENDOR_SQC_CHARGER
extern int sprd_battery_get_battery_info_sqc(struct power_supply *psy, struct sprd_battery_info *info, int battery_id);
#endif
extern void sprd_battery_find_resistance_table(struct power_supply *psy,
					       ...
					       int *target_table);
extern int sprd_battery_parse_battery_id(struct power_supply *psy, struct sprd_battery_info *data);
