...
static ssize_t prefree_segments_show(struct f2fs_attr *a,
		struct f2fs_sb_info *sbi, char *buf)
{
	return sprintf(buf, "%llu\n",
			(unsigned long long)(prefree_segments(sbi)));
}
...
F2FS_GENERAL_RO_ATTR(prefree_segments);
