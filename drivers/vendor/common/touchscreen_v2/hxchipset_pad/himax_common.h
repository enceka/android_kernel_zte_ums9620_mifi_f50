...
#define HIMAX_DRIVER_VER "3.0.0.22_#5831_P720P01_03"
...
extern uint8_t g_pen_switch_flag;
#endif
...
#define	HX_FULL_STACK_RAWDATA_SIZE_CONFIG \
	(HX_STACK_ORG_LEN +\
	(2 + FIX_HX_RX_NUM_CONFIG * FIX_HX_TX_NUM_CONFIG + FIX_HX_TX_NUM_CONFIG + FIX_HX_RX_NUM_CONFIG)\
	* 2)
#endif
