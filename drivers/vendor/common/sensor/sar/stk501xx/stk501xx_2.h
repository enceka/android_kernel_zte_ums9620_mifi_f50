...
#define STK_SAR_THD_0                       20000  // 4500 touch detect threshold
...
#else
    #define PHASE_EN 0x01  //use phase 0
...
#define STK_RXIO0_MUX_REG_VALUE                 0x22222222

#define STK_ADDR_RXIO1_MUX_REG                  0x005C
#define STK_RXIO1_MUX_REG_VALUE                 0x22222222
...
#define STK_RXIO6_MUX_REG_VALUE                 0x22222222
...
#define STK_SCAN_PERIOD_VALUE                   0x00000244 //29ms
...
#else
    #define STK_TX_CTRL_PH0_VALUE                   0x05000404  // TX125Khz,Resoultion=256
#endif
...
#else
    #define STK_TX_CTRL_PH1_VALUE                   0x06000B0B
#endif
...
#else
    #define STK_TX_CTRL_PH2_VALUE                   0x06000B0B
#endif
...
#else
    #define STK_TX_CTRL_PH3_VALUE                   0x06000B0B
#endif
...
#else
    #define STK_TX_CTRL_PH4_VALUE                   0x06000B0B
#endif
...
#else
    #define STK_TX_CTRL_PH5_VALUE                   0x06000B0B
#endif
...
#else
    #define STK_TX_CTRL_PH6_VALUE                   0x06000B0B
#endif
...
#else
    #define STK_TX_CTRL_PH7_VALUE                   0x06000B0B
#endif
